...
Usamos html, css e javascript. utilizamos bootstrap para alguns estilos, e json e local storage para amazenamento de dados
...
1-link entre a home page com as outras.
2- sinstema de login e cadastro estavam armazenando e validando os dados do usuario
3- se o usuario conseguia acessar o cardapio e oos detalhes do cadapio
4-se o cliente conseguia reserva mesas 
5-e tela dde gerenciamento do cardapio


## Ferramentas de Testes (Opcional)

testamos na propria ide no caso vscode etambem o navegador google chrome
...
Tivemos Problemas em armaznar os dados em json serve, a soluçao foi estudar e começar a praticar o uso do para armazenagem de dados


# Referências

Nos estudamos alguns videos do romeo e  na maioria das vezes tiramos duvidass com o professsor em sala e tambem utilizamos o youtube para saber executar algumas funcionalidaddes
https://www.youtube.com/
https://pucminas.instructure.com/courses/157300
