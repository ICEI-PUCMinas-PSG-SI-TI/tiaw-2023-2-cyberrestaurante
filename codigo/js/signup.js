...
function cadastrar() {
  if (validNome && validUsuario && validSenha && validConfirmSenha && validEmail && validNumero) {
...
numero.addEventListener('keyup', () => {
  ...
  if (!numeroRegex.test(numero.value)) {
    ...
    labelNumero.innerHTML = 'Número *Insira apenas números';
